...
class AppTheme {
  ...
  static const Color loadingOperationColor = Color(0xFF3498DB);  // Blue for loading
  static const Color unloadingOperationColor = Color(0xFF2ECC71); // Green for unloading
  static const Color stableWeightColor = Color(0xFF27AE60);      // Green for stable
  static const Color unstableWeightColor = Color(0xFFF39C12);    // Orange for unstable
...
class WeighingTheme {
  ...
  static BoxDecoration get loadingOperationDecoration => BoxDecoration(
    ...
    border: Border.all(color: AppTheme.loadingOperationColor.withOpacity(0.3)),
  );
  ...
  static BoxDecoration get unloadingOperationDecoration => BoxDecoration(
    ...
    borderRadius: BorderRadius.circular(8),
    border: Border.all(color: AppTheme.unloadingOperationColor.withOpacity(0.3)),
  );
  ...
  static material.InputDecoration getFormFieldDecoration(String label, {IconData? icon}) {
    return material.InputDecoration(
      labelText: label,
      prefixIcon: icon != null ? Icon(icon, color: AppTheme.secondaryTextColor) : null,
