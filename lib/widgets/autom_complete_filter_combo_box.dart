...
class AutoCompleteFilterComboBox extends StatefulWidget {
  ...
  const AutoCompleteFilterComboBox(
      {super.key,
  ...
  @override
  State<AutoCompleteFilterComboBox> createState() =>
      _AutoCompleteFilterComboBoxState();
}

class _AutoCompleteFilterComboBoxState
    extends State<AutoCompleteFilterComboBox> {
  ...
  @override
  void didUpdateWidget(AutoCompleteFilterComboBox oldWidget) {
